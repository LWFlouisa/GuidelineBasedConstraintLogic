...
first_assertion = File.join(File.dirname(__FILE__), 'scripts/first_assertion.azu')
file1 = File.readlines(first_assertion)

second_assertion = File.join(File.dirname(__FILE__), 'scripts/second_assertion.azu')
file2 = File.readlines(second_assertion)

third_assertion = File.join(File.dirname(__FILE__), 'scripts/third_assertion.azu')
file3 = File.readlines(third_assertion)

parser    = GBCLParser.new
transform = GBCLTransform.new

begin    
  ast1         = transform.apply(file1)
  ast2         = transform.apply(file2)
  ast3         = transform.apply(file3)
